...
class WebDatapimpinanController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        // $p = PimpinanEcoranger::where('user_id', auth()->user()->id)->first();
            ...
            $user->save();
                ...
                alert()->success('Dengan password : rahasia','Berhasil menambahkan');
                return back();
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $petugaslap = PimpinanEcoranger::findOrFail($id);
        $p = PimpinanEcoranger::where('user_id', auth()->user()->id)->first();
        $input = ([
            'nama' => $request->nama,
            'nohp' => $request->nohp,
