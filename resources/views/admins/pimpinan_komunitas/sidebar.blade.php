<ul class="sidebar-menu-pimpinankomunitas">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a class="nav-link" href="/daftarkomunitas-pimpinankom">Daftar Komunitas</a></li>
      <li><a class="nav-link" href="/kelolaagenda-pimpinankom">Kelola Agenda</a></li>
    </ul>
  </li>
  ...
  <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
    <a href="/" class="btn btn-primary-pimpinankomunitas btn-lg btn-block btn-icon-split">
