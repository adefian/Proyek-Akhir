                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        ...
                                                        <img height="100" id="myImg" src="{{$kom->ambilGambar()}}" data-toggle="modal" data-target="#myModal"></img>
                                                        @else
                                                        -
                                                        @endif
                                                    </td>
...
<script>
    $(document).ready(function() {
        ...
        table.on('click', '.edit', function() {
            ...
            $('#editForm').attr('action', 'kelolaagenda/' + data[8]);
            $('#editFormpimpinankom').attr('action', 'kelolaagenda-pimpinankom/' + data[8]);
            $('#editFormkomunitas').attr('action', 'kelolaagenda-komunitas/' + data[8]);
